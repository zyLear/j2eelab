package com.zylear.j2eelab.zookeeper.demos;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.google.common.collect.Maps;
import com.zylear.j2eelab.common.PropertyFactory;
import com.zylear.j2eelab.util.IpUtils;
...
//                        throw new CheckLastTimeException("init timestamp check error,forever node timestamp gt this node time");
    ...
    public static void main(String[] args) {
        SnowflakeZookeeperHolder holder = new SnowflakeZookeeperHolder(IpUtils.getIp(), String.valueOf("8080"), "127.0.0.1");
    }
